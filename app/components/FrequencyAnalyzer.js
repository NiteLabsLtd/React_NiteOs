  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div style={{ marginTop: "8px", textAlign: "center", color: "darkgray" }}>
          ...
          <input
            ...
            style={{ backgroundColor: "darkgray", border: "none" }}
          />
          <span style={{ marginLeft: "8px" }}>{gain.toFixed(1)}</span>
        </div>
        <div style={{ marginTop: "8px", textAlign: "center", backgroundColor: "darkgray", padding: "4px", borderRadius: "4px", color: "white" }}>
          <div>
